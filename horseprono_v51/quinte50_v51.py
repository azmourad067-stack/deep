"""Générateur de 50 combinaisons Quinté V5.1 à partir du Top10 officiel.

Objectif : construire 50 tickets uniques de 5 chevaux uniquement parmi les
...
# Exposition-cible sur 50 tickets (250 places au total).
# Elle donne beaucoup de poids aux 5 premiers sans éliminer les rangs 6-10.
TARGET_EXPOSURES = [39, 37, 35, 33, 31, 23, 19, 15, 10, 8]
...
def generate_quinte_50(ranked: pd.DataFrame) -> tuple[pd.DataFrame, pd.DataFrame]:
    """Retourne (50 tickets Quinté, tableau d'exposition des 10 chevaux).
